...
Detect the position, size, rotation, and perspective of a **Jankó piano in a photograph** by predicting the four corners of a quadrilateral surrounding the keys that are fully visible.
